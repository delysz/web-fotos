...
// --- ICONOS SVG MEJORADOS (con props opcionales) ---
const Icons = {
  Mail: (props?: { className?: string; size?: number }) => (
    <svg 
  ...
  Instagram: (props?: { className?: string; size?: number }) => (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={props?.size || 18} 
      height={props?.size || 18} 
  ...
  Facebook: (props?: { className?: string; size?: number }) => (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={props?.size || 18} 
      height={props?.size || 18} 
  ...
  Flickr: (props?: { className?: string; size?: number }) => (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={props?.size || 18} 
      height={props?.size || 18} 
  ...
  ChevronLeft: (props?: { className?: string; size?: number }) => (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={props?.size || 24} 
  ...
  ChevronRight: (props?: { className?: string; size?: number }) => (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={props?.size || 24} 
      height={props?.size || 24} 
  ...
  X: (props?: { className?: string; size?: number }) => (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={props?.size || 24} 
      height={props?.size || 24} 
  ...
  Heart: (props?: { className?: string; size?: number }) => (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={props?.size || 16} 
  ...
  ImageIcon: (props?: { className?: string; size?: number }) => (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={props?.size || 16} 
      height={props?.size || 16} 
  ...
  Aperture: (props?: { className?: string; size?: number }) => (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={props?.size || 16} 
      height={props?.size || 16} 
...
export default function Gallery({ fotos }: GalleryProps) {
  ...
  const headerSpring = useSpring(headerScale, {
    stiffness: 100,
    damping: 30
  });

  // InView animations for photos
      ...
      <section className="bg-[#0a0a0a] min-h-screen pt-20 pb-10 px-4 sm:px-8 select-none flex flex-col relative overflow-x-hidden">
        ...
        >
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            ...
            >
              <h1 className="text-xl md:text-2xl font-serif text-white tracking-widest uppercase opacity-90">
                Marian <span className="text-gray-600 font-light italic">&</span>
              </h1>
        ...
        <div className="relative mt-32 mb-20 text-center z-10">
          ...
          >
            <div className="relative inline-block">
              ...
              <motion.div 
                className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-48 h-px bg-gradient-to-r from-transparent via-white to-transparent"
                initial={{ scaleX: 0 }}
                animate={{ scaleX: 1 }}
            ...
            <motion.p 
              className="text-gray-500 text-sm tracking-[0.3em] uppercase mt-12 max-w-2xl mx-auto leading-relaxed"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              <div className="flex items-center justify-center gap-8 text-gray-400 text-xs tracking-[0.2em] uppercase">
                ...
                <motion.span 
                  ...
                  whileHover={{ scale: 1.1 }}
                >
                  <Icons.ImageIcon size={12} /> Retratos
                </motion.span>
                <span className="text-gray-600">•</span>
                <motion.span 
                  className="flex items-center gap-2"
                  whileHover={{ scale: 1.1 }}
                >
                  <Icons.Aperture size={12} /> Detalles
                </motion.span>
              </div>
            </motion.div>
          </motion.div>
        ...
        >
          <div className="flex flex-wrap justify-center gap-2 md:gap-4">
            {categories.map((cat, index) => (
              <motion.button 
                ...
                className={`text-xs px-5 py-3 rounded-full font-medium tracking-[0.15em] uppercase transition-all duration-300 cursor-pointer relative overflow-hidden group ${
                  filter === cat 
          ...
          >
            <p className="text-gray-600 text-[10px] tracking-[0.3em] uppercase">
              {filteredFotos.length} obras encontradas
            </p>
          </motion.div>
        </motion.div>
        ...
        <div ref={gridRef} className="flex-grow z-0">
          {filteredFotos.length === 0 ? (
            <motion.div 
              ...
              animate={{ opacity: 1 }}
            >
              <div className="w-16 h-16 text-gray-800 mx-auto mb-6">
                ...
                {filteredFotos.map((foto, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="relative w-full aspect-square overflow-hidden rounded-2xl bg-gradient-to-br from-neutral-900 to-black border border-neutral-900 shadow-2xl shadow-black/50 group-hover:shadow-white/10 transition-all duration-700">
                        ...
                        {foto.imagen && (
                          <>
                            ...
                            <Image 
                              src={urlFor(foto.imagen as any).width(1200).height(1200).fit('crop').url()}
                        ...
                        {/* CONTENIDO FLOTANTE */}
                        <motion.div 
                          className="absolute bottom-0 left-0 right-0 p-8 transform translate-y-full group-hover:translate-y-0 transition-all duration-700 ease-out"
                          initial={false}
                        >
                          <div className="space-y-3">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {foto.categories?.map((cat, i) => (
                                <motion.span 
                                  key={cat}
                                  className="px-3 py-1 bg-white/10 backdrop-blur-sm rounded-full text-white text-[10px] tracking-widest uppercase border border-white/10"
                        ...
                        {/* BOTÓN FLOTANTE */}
                        <motion.button 
                          className="absolute top-6 right-6 w-10 h-10 rounded-full bg-black/50 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500"
                      ...
                      <motion.div 
                        className="absolute -bottom-4 left-1/4 right-1/4 h-px bg-gradient-to-r from-transparent via-white to-transparent opacity-0 group-hover:opacity-50"
                        animate={isHovered ? {
                          scaleX: [0, 1, 0],
                          opacity: [0, 0.5, 0]
                        } : {}}
        ...
        {/* FOOTER MEJORADO */}
        <motion.footer 
          className="mt-32 pt-12 border-t border-neutral-900 text-center space-y-6 z-10 pb-12"
          initial={{ opacity: 0 }}
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto px-4">
            ...
            <div className="flex items-center gap-6">
              {['Instagram', 'Facebook', 'Email'].map((social, i) => (
                <motion.a
                  key={social}
                  href="#"
                  ...
                  transition={{ delay: i * 0.1 }}
                >
                  {social === 'Instagram' && <Icons.Instagram size={20} />}
                  {social === 'Facebook' && <Icons.Facebook size={20} />}
                  {social === 'Email' && <Icons.Mail size={20} />}
                </motion.a>
              ))}
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-neutral-900">
            <p className="text-neutral-600 text-[10px] tracking-[0.2em] uppercase mb-2">
            ...
            <a 
              ...
              className="inline-block text-neutral-800 hover:text-neutral-600 transition-colors text-[9px] tracking-widest cursor-pointer group"
            >
          ...
          {isModalOpen && selectedFoto && (
            <>
              <motion.div 
                ...
                className="fixed inset-0 z-[999] flex items-center justify-center bg-black/95 backdrop-blur-xl p-4 cursor-zoom-out"
              >
                {/* BACKGROUND PATTERN */}
                ...
                {filteredFotos.length > 1 && (
                  <>
                    <motion.button 
                      ...
                      className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 z-50 p-4 text-white/50 hover:text-white rounded-full transition-all cursor-pointer hidden md:flex items-center justify-center bg-black/20 backdrop-blur-sm border border-white/10 hover:border-white/30"
                    ...
                    <motion.button 
                      ...
                      className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 z-50 p-4 text-white/50 hover:text-white rounded-full transition-all cursor-pointer hidden md:flex items-center justify-center bg-black/20 backdrop-blur-sm border border-white/10 hover:border-white/30"
                      whileHover={{ scale: 1.1, x: 5 }}
                      whileTap={{ scale: 0.9 }}
                    >
                      ...
                      <>
                        ...
                        <div ref={modalImageRef} className="relative z-10 transition-opacity duration-500">
                          <Image 
                            ...
                            src={urlFor(selectedFoto.imagen as any).width(1920).quality(100).url()} 
                            ...
                            draggable={false} 
                            onLoadingComplete={() => setIsImageLoaded(true)} 
                            className={`w-full h-auto max-h-[75vh] object-contain rounded-xl shadow-2xl transition-all duration-700 ${
                              isImageLoaded 
                    ...
                    >
                      ...
                      <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-gray-400">
                        <div className="flex items-center gap-2">
                          {selectedFoto.categories?.map((cat, i) => (
                            <span key={cat} className="px-3 py-1 bg-white/5 rounded-full text-xs tracking-widest">
                              {cat}
                            </span>
                          ))}
                        </div>
                ...
                {isImageLoaded && (
                  <motion.button 
                    onClick={handleCloseModal} 
                    className="absolute top-4 right-4 text-white/50 hover:text-white transition-colors z-30 p-3 rounded-full cursor-pointer bg-black/30 backdrop-blur-sm border border-white/10 hover:border-white/30"
                ...
                {filteredFotos.length > 1 && (
                  <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex gap-2 z-50 md:hidden">
                    {filteredFotos.map((_, i) => (
                      <button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          setCurrentIndex(i);
                          setSelectedFoto(filteredFotos[i]);
                          setIsImageLoaded(false);
                        }}
        ...
        {/* DRAWER PERFIL / CONTACTO MEJORADO */}
        <AnimatePresence>
          {isContactOpen && (
            <>
              <motion.div 
                ...
                exit={{ opacity: 0 }}
                onClick={toggleContact}
                className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[70] cursor-default"
              />
              ...
              <motion.aside 
                ...
                animate="visible"
                exit="exit"
                className="fixed top-0 right-0 z-[80] h-full w-full md:w-[600px] bg-gradient-to-b from-[#0c0c0c] to-black border-l border-neutral-900 shadow-2xl overflow-hidden cursor-default"
                onClick={(e) => e.stopPropagation()}
              >
                {/* DECORATIVE ELEMENTS */}
                ...
                <motion.button 
                  onClick={toggleContact} 
                  className="absolute top-6 right-6 p-3 text-neutral-500 hover:text-white transition-colors cursor-pointer rounded-full hover:bg-neutral-800/50 backdrop-blur-sm z-50 border border-white/10"
                ...
                <div className="flex flex-col min-h-full p-8 md:p-12 pt-24 overflow-y-auto">
                  {/* PROFILE SECTION */}
                  <motion.div variants={itemVariants} className="mb-12">
                    ...
                    <motion.h2 
                      className="text-5xl font-serif text-white tracking-widest uppercase mb-4"
                      animate={{ 
                        textShadow: [
                    ...
                    <p className="text-neutral-500 text-sm tracking-[0.3em] uppercase mb-6 border-b border-white/10 pb-8">
                  ...
                  <motion.div variants={itemVariants} className="mb-16">
                    <p className="text-gray-400 font-light leading-relaxed text-lg italic mb-8">
                      "Exploradora de la luz y el entorno natural. Mi obra transita entre la inmensidad del paisaje abierto y la delicadeza del mundo macro, buscando siempre ese instante donde la emoción y la naturaleza convergen."
                    </p>
                  ...
                  <motion.div variants={itemVariants} className="space-y-4 mb-16">
                    ...
                    {[
                      ...
                      <motion.a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group flex items-center justify-between p-5 rounded-2xl border border-white/5 hover:border-white/20 hover:bg-white/5 transition-all cursor-pointer bg-gradient-to-r from-transparent to-white/5"
                        whileHover={{ x: 10 }}
                        initial={{ opacity: 0, x: -20 }}
                        animate={{ opacity: 1, x: 0 }}
                        transition={{ delay: i * 0.1 }}
                      >
                        <div className="flex items-center gap-5">
                          ...
                          <div>
                            <span className="text-sm font-light text-gray-400 group-hover:text-white tracking-wide block">
                              {link.label}
                            </span>
                            <span className="text-xs text-gray-600 group-hover:text-gray-400">
                              {link.label === 'Email' ? 'Respuesta en 24h' : 'Sígueme'}
                            </span>
                          </div>
                        </div>
                        <motion.span 
                          className="text-gray-600 group-hover:text-white group-hover:translate-x-2 transition-all text-xl"
                  ...
                  >
                    ...
                    <p className="text-gray-500 text-xs mt-2">Disponible para proyectos en toda Europa</p>
                  </motion.div>
                </div>
              </motion.aside>
            </>
        ...
        <AnimatePresence>
          {isScrolled && (
            <motion.button
              ...
              className="fixed bottom-8 right-8 w-12 h-12 rounded-full bg-white/10 backdrop-blur-sm border border-white/10 flex items-center justify-center z-50 cursor-pointer hover:bg-white/20 transition-all"
